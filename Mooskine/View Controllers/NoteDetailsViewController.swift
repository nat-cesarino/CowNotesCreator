...
//        try? note.managedObjectContext?.save()
        // This line below is the same thing as above, but prepared for multiple contexts:
...
extension NoteDetailsViewController {
    ...
    func makeToolbarItems() -> [UIBarButtonItem] {
        ...
        let bold = UIBarButtonItem(image: UIImage(imageLiteralResourceName: "toolbar-bold"), style: .plain, target: self, action: #selector(boldTapped(sender:)))
        let red = UIBarButtonItem(image: UIImage(imageLiteralResourceName: "toolbar-underline"), style: .plain, target: self, action: #selector(redTapped(sender:)))
        let cow = UIBarButtonItem(image: UIImage(imageLiteralResourceName: "toolbar-cow"), style: .plain, target: self, action: #selector(cowTapped(sender:)))
